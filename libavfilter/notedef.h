...
typedef struct {
    unsigned int instrument_1;
    unsigned int instrument_2;
    unsigned int instrument_3;
    unsigned int beat;
}percussion_structure;
...
#define jazz1 {12,  {{Bass_Drum_1, Ride_Cymbal_2, 1, 12},\
                    ...
                    {1, 1, 1, 12}, \
                    {Electric_Snare, Ride_Cymbal_2, 1, 12}}}
#define jazz2 {12, {{1, Ride_Cymbal_2, 1, 12}, \
                    {1, 1, 1, 12}, \
                    {Bass_Drum_1, 1, 1, 12}, \
                    {Electric_Snare, Ride_Cymbal_2, Pedal_Hi_Hat, 12}, \
                    {1, 1, 1, 12}, \
                    ...
                    {1, 1, 1, 12}, \
                    {Bass_Drum_1, Ride_Cymbal_2, 1, 12}}}
#define jazz3 {12, {{1, Ride_Cymbal_2, 1, 12},\
                    {1, 1, 1, 12}, \
                    {1, 1, 1, 12}, \
                    ...
                    {1, 1, 1, 12}, \
                    {1, Ride_Cymbal_2, 1, 12}}}
#define jazz4 {12, {{1, Ride_Cymbal_2, 1, 12}, \
                    {Electric_Snare, 1, 1, 12}, \
                    {Electric_Snare, 1, 1, 12}, \
                    {1, Ride_Cymbal_2, Pedal_Hi_Hat, 12}, \
                    {1, 1, 1, 12}, \
                    ...
                    {1, 1, 1, 12}, \
                    {1, Ride_Cymbal_2, 1, 12}}}
#define jazz5 {12, {{Electric_Snare, Ride_Cymbal_2, 1, 12}, \
                    {Electric_Snare, 1, 1, 12}, \
                    {Bass_Drum_1, 1, 1, 12}, \
                    {1, Ride_Cymbal_2, Pedal_Hi_Hat, 12}, \
                    {1, 1, 1, 12}, \
                    ...
                    {1, 1, 1, 12}, \
                    {1, Ride_Cymbal_2, 1, 12}}}
#define jazz6 {12, {{1, Ride_Cymbal_2, 1, 12}, \
                    {1, 1, 1, 12}, \
                    {Electric_Snare, 1, 1, 12}, \
                    {1, Ride_Cymbal_2, Pedal_Hi_Hat, 12}, \
                    {Electric_Snare, 1, 1, 12}, \
                    ...
                    {1, 1, 1, 12}, \
                    {1, Ride_Cymbal_2, 1, 12}}}
#define rock1 {8, {{Bass_Drum_1, 1, Closed_Hi_Hat, 8}, \
                    {1, 1, Closed_Hi_Hat, 8}, \
                    ...
                    {Acoustic_Snare, 1, Closed_Hi_Hat, 8}, \
                    {1, 1, Closed_Hi_Hat, 8}}}
#define rock2 {8, {{Bass_Drum_1, 1, Closed_Hi_Hat, 8}, \
                    {Bass_Drum_1, 1, Closed_Hi_Hat, 8}, \
                    {Acoustic_Snare, 1, Closed_Hi_Hat, 8}, \
                    {Bass_Drum_1, 1, Closed_Hi_Hat, 8}, \
                    {Bass_Drum_1, 1, Closed_Hi_Hat, 8}, \
                    ...
                    {Bass_Drum_1, 1, Closed_Hi_Hat, 8}, \
                    {1, 1, Closed_Hi_Hat, 8}}}
#define rock3 {8, {{Bass_Drum_1, 1, Closed_Hi_Hat, 8}, \
                    {Bass_Drum_1, 1, Closed_Hi_Hat, 8}, \
                    {Acoustic_Snare, 1, Closed_Hi_Hat, 8}, \
                    {Bass_Drum_1, 1, Closed_Hi_Hat, 8}, \
                    {1, 1, Closed_Hi_Hat, 8}, \
                    ...
                    {Acoustic_Snare, 1, Closed_Hi_Hat, 8}, \
                    {1, 1, Closed_Hi_Hat, 8}}}
#define rock4 {8, {{Bass_Drum_1, Acoustic_Snare, Closed_Hi_Hat, 8}, \
                    {1, 1, Closed_Hi_Hat, 8}, \
                    ...
                    {1, Acoustic_Snare, Closed_Hi_Hat, 8}, \
                    {Bass_Drum_1, 1, Closed_Hi_Hat, 8}}}
#define shuffle {12, {{Bass_Drum_1, 1, Closed_Hi_Hat, 12}, \
                    {1, 1, 1, 12}, \
                    ...
                    {1, 1, 1, 12}, \
                    {1, 1, Closed_Hi_Hat, 12}}}
#define metronome {4, {{Metronome_Click, 1, 1, 4}, \
                        {Metronome_Click, 1, 1, 4}, \
                        {Metronome_Click, 1, 1, 4}, \
                        {Metronome_Click, 1, 1, 4}}}

const percussion Track_1 = jazz1;
const percussion Track_2 = jazz2;
const percussion Track_3 = jazz3;
const percussion Track_4 = jazz4;
const percussion Track_5 = jazz5;
const percussion Track_6 = jazz6;
const percussion Track_7 = rock1;
